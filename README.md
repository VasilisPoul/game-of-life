...
### Έξοδος script
Η έξοδος του script που τρέξαμε, είχε με το παρακάτω format: 
  Όπου:
...
Έξοδος για μέγεθος προβλήματος **5120x5120** (Mε collapse):
...
>>>>>>> 13db47d65596d56b2d50684ecd71d7556c0d5992

*\* Όλες οι μετρήσεις πραγματοποιήθηκαν στην argo.*
**\* Όλες οι μετρήσεις έγιναν για 1000 βήματα.*
*** *Σε όλες τις μετρήσεις, έχουμε κάνει comment out το σημείο στο οποίο γράφεται το τρέχον generation σε αρχείο για να γίνουν πιο γρήγορα.* 
